<div class="row">
    <div class="roomclasses view col-md-10">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-th-list"></i> <?php echo __('Roomclass'); ?></h3>
            </div> <!-- /panel-header -->
		...
		<td>
			<?php echo h($roomclass['Roomclass']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><?php echo __('Name'); ?></td>
		<td>
			<?php echo h($roomclass['Roomclass']['name']); ?>
			&nbsp;
		</td>
</tr>                    </table>
                </div>
		...
		<th><?php echo __('Image'); ?></th>
                        	...
                        	<?php foreach ($roomclass['Room'] as $room): ?>
		<tr>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <ul class="list-group bord-no">
                    		...
                    		<li class="list-group-item"><?php echo $this->Html->link(__('Edit Roomclass'), array('action' => 'edit', $roomclass['Roomclass']['id'])); ?> </li>
		<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete Roomclass'), array('action' => 'delete', $roomclass['Roomclass']['id']), array(), __('Are you sure you want to delete # %s?', $roomclass['Roomclass']['id'])); ?> </li>
		<li class="list-group-item"><?php echo $this->Html->link(__('List Roomclasses'), array('action' => 'index')); ?> </li>
		<li class="list-group-item"><?php echo $this->Html->link(__('New Roomclass'), array('action' => 'add')); ?> </li>
